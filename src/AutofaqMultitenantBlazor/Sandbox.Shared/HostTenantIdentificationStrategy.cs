...
{
    public class HostTenantIdentificationStrategy : ITenantIdentificationStrategy
    {
        private readonly ILogger<QueryStringTenantIdentificationStrategy> _logger;

        public HostTenantIdentificationStrategy(IHttpContextAccessor accessor, ILogger<QueryStringTenantIdentificationStrategy> logger)
        {
            Accessor = accessor;
            _logger = logger;
        }
        ...
        public bool TryIdentifyTenant(out object tenantId)
        {
            ...
            {
                tenantId = context.Request.Host.Host;
